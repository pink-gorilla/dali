  ...
  [[:licenses
   ...
   [:developers
    [:developer
     [:name "pink-gorilla"]]]
   [:scm 
     [:url "https://github.com/pink-gorilla/dali"]
     [:connection "scm:git:git://github.com/pink-gorilla/dali.git"]
     [:developerConnection "scm:git:ssh://git@github.com/pink-gorilla/dali.git"]]])
